...
{
    public class UmbreonCardActivateAnimates : EmptyCardActivateAnimate
    {
        ...
        public UmbreonCardActivateAnimates(World world) : base(world)
        {
            MaxLen = Len1 + Len2 + Len3;
            string[] Fn = { "Sources/Illust/93919102_p0.png" };
