...
{
    public class GlaceonCardActivateAnimate:EmptyCardActivateAnimate
    {
        ...
        public GlaceonCardActivateAnimate(World world) : base(world)
        {
            MaxLen = Len1 + Len2 + Len3;
            string[] Fn = { "Sources/Illust/92437488_p0.png" };
