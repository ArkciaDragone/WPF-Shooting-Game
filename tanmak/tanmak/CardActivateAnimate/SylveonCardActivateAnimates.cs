...
{
    public class SylveonCardActivateAnimates : EmptyCardActivateAnimate
    {
        ...
        public SylveonCardActivateAnimates(World world) : base(world)
        {
            MaxLen = Len1 + Len2 + Len3;
            string[] Fn = { "Sources/Illust/93547891_p0.png" };
